...
function WavPackInfo(fileobj) {
  ...
  if (readCount !== 28 || header.toString('binary', 0, 4) !== 'wvpk') {
...
WavPackInfo.prototype.pprint = function() {
  ...
  return "WavPack, " + roundedLength + " seconds, " +
    this.sample_rate + " Hz";
};
